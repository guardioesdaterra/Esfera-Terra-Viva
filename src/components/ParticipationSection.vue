<template>
  <TextureSection type="basket" :opacity="0.2" blend-mode="multiply" color="#4A3728">
    ...
    <div class="participation-ways">
      <div class="participation-card reveal reveal-delay-1" v-for="(item, i) in participationItems" :key="i">
        ...
        <a href="https://www.instagram.com/esferaterraviva" target="_blank" class="btn-organic pw-btn">
          <span>{{ item.cta }}</span>
